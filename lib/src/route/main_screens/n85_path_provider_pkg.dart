...
class N85PathProviderPackage extends StatefulWidget {
  N85PathProviderPackage({Key? key}) : super(key: key);

  @override
  _N85PathProviderPackageState createState() => _N85PathProviderPackageState();
}

class _N85PathProviderPackageState extends State<N85PathProviderPackage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Test path_provider package"),
      ),
      body: Center(
        child: ListView(
          children: <Widget>[
